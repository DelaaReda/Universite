...
-- insert into cour(id,nb_credits, nb_max_etudiants, obligatoire)
-- values('INF-1001',46, 34, true);

-- insert into etudiant(code_perm, stud_id)
-- values('CODE9999990T', 'STUD1000');
--
-- insert into personne(id, courriel, date_naiss, nom, prenom)
-- values('STUD1000', 'CODE9999990T','reda@mail.fr', {ts '1980-09-17 18:47:52.69'}, 'Med', 'Red');
